...
<html>
<head>
	<title>Food Box Store | Contact </title>
			...
			<div class="row contact-grids agile-1 mb-5">
				<div class="col-sm-4 contact-grid agileinfo-6 mt-sm-0 mt-2">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;">Food Box Store
							<label style="font-weight: bold;color:black;"> Building No.51/B xxxxxxxx Society Goregaon(E), 400000</label>
						</p>
					</div>
				</div>
...
<!-- 							<label>+(91) 121 122 000</label> -->
				...
				<div class="col-sm-4 contact-grid agileinfo-6">
					<div class="contact-grid1 text-center">
						...
						<p>
							<a style="font-weight: bold;color:black;" href="mailto:yagyeshjaiswal98@gmail.com">yagyeshjaiswal98@gmail.com</a>
						</p>
					</div>
				</div>
			</div>
