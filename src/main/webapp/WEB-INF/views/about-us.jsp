...
<html>
<head>
	<title>Food Box Store | About </title>
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<div class="col-lg-6 welcome-left">
					<h3>About Store</h3>
					<h4 class="my-sm-3 my-2">Food Box(Food Box Store) is a low-price online  store, which has many vital ranging products consumed in our everyday Breakfast, Meals & Dinners. . All the products on our
